...
const updateClientSchema = z.object({
    ...
    fixedIp: z.string().optional().describe('Static DHCP reservation IP. Implies useFixedAddr: true.'),
    useFixedAddr: z.boolean().optional().describe('Set false to release an existing fixed-IP reservation.'),
